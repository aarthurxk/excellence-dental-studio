    ...
    <header className="sticky top-0 z-50 w-full bg-background/95 backdrop-blur border-b border-border">
      <div className="container flex h-20 items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-3">
          <a href="tel:8132993019" className="flex items-center gap-2 text-sm text-muted-foreground hover:text-primary transition-colors">
        ...
        <div className="lg:hidden border-t border-border bg-background animate-in slide-in-from-top-2">
          <nav className="container py-4 flex flex-col gap-1">
            {navLinks.map((link) => (
              <Link
                ...
                className={`px-4 py-3 rounded-md text-sm font-medium transition-colors ${
                  location.pathname === link.href
                    ? "text-primary bg-clinic-red-light font-semibold"
            ...
            <div className="mt-3 pt-3 border-t border-border flex flex-col gap-2">
              <a href="tel:8132993019" className="flex items-center gap-2 px-4 py-2 text-sm text-muted-foreground">
                <Phone className="h-4 w-4" /> (81) 3299-3019
              </a>
